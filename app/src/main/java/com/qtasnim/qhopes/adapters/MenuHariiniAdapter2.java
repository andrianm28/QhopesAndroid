...
public class MenuHariiniAdapter2 extends RecyclerView.Adapter<MenuHariiniAdapter2.MyViewHolder> {

    private ArrayList<MenuHariiniModel> mMenuHariiniModel;
    private View.OnClickListener mOnItemClickListener;

    public MenuHariiniAdapter2(ArrayList<MenuHariiniModel> mMenuHariiniModel) {
