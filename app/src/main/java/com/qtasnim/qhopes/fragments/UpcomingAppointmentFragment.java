...
import com.qtasnim.qhopes.adapters.AppointmentAdapter;
...
public class UpcomingAppointmentFragment extends Fragment {
    ...
    private ArrayList<AppointmentModel> mModelData = new ArrayList<>();
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // viewHolder.itemView;
            AppointmentModel mAppointmentModel = mModelData.get(position);
    ...
    private void setDialog(AppointmentModel currentModel) {
